...
- 场景：`tamper`，时间：`1000 ms`
- 结果：`{'type': 'tamper', 'legacy_lru': {'accepted': True, 'reason': 'accepted'}, 'parity_valid': True, 'hardened_gateway': {'accepted': False, 'reason': 'authentication'}, 'hardened_physical_output': False, 'wire': {'tx_channel': 0, 'rx_channel': 0, 'requested_ms': 1000, 'start_ms': 1001.44, 'end_ms': 1001.8, 'word_duration_ms': 0.36, 'bit_rate_bps': 100000, 'raw_word': '0x81e46083', 'observed_raw_word': '0x81e46083', 'fault': None}}`
