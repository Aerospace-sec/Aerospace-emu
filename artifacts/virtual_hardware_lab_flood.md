...
- 场景：`flood`，时间：`1000 ms`
- 结果：`{'type': 'flood', 'attacker_frames': 64, 'legacy_lru_accepted': 64, 'hardened_gateway_rejected': 64, 'physical_events_submitted': 64, 'tx_fifo_overflow': 0, 'hardened_physical_output': False, 'first_wire': {'tx_channel': 0, 'rx_channel': 0, 'requested_ms': 1000, 'start_ms': 1001.44, 'end_ms': 1001.8, 'word_duration_ms': 0.36, 'bit_rate_bps': 100000, 'raw_word': '0x001f4083', 'observed_raw_word': '0x001f4083', 'fault': None}, 'last_wire': {'tx_channel': 0, 'rx_channel': 0, 'requested_ms': 1000, 'start_ms': 1024.12, 'end_ms': 1024.48, 'word_duration_ms': 0.36, 'bit_rate_bps': 100000, 'raw_word': '0x80203c83', 'observed_raw_word': '0x80203c83', 'fault': None}}`
